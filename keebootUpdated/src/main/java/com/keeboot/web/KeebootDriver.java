...
import com.keeboot.utils.dataHelpers.DataWarehouse;
import com.keeboot.web.debugging.Colors;
import com.keeboot.web.debugging.Highlight;
import com.keeboot.web.webelements.Button;
import com.keeboot.web.webelements.Checkbox;
import com.keeboot.web.webelements.Element;
import com.keeboot.web.webelements.Label;
import com.keeboot.web.webelements.Link;
import com.keeboot.web.webelements.Listbox;
import com.keeboot.web.webelements.RadioGroup;
import com.keeboot.web.webelements.Textbox;
import com.keeboot.web.webelements.Webtable;
import com.keeboot.web.webelements.impl.ButtonImpl;
import com.keeboot.web.webelements.impl.CheckboxImpl;
import com.keeboot.web.webelements.impl.ElementImpl;
import com.keeboot.web.webelements.impl.LabelImpl;
import com.keeboot.web.webelements.impl.LinkImpl;
import com.keeboot.web.webelements.impl.ListboxImpl;
import com.keeboot.web.webelements.impl.RadioGroupImpl;
import com.keeboot.web.webelements.impl.TextboxImpl;
import com.keeboot.web.webelements.impl.WebtableImpl;

public class KeebootDriver implements WebDriver, TakesScreenshot {
     ...
     */
    public KeebootDriver(DesiredCapabilities caps) {
     ...
     *            -
     */
    public KeebootDriver(DesiredCapabilities caps, URL url) {
        currentPageTimeout = Constants.PAGE_TIMEOUT;
        currentElementTimeout = Constants.ELEMENT_TIMEOUT;
        currentScriptTimeout = Constants.DEFAULT_GLOBAL_DRIVER_TIMEOUT;
    ...
    public void get(String url) {
        try {
            driver.get(url);
            PageLoaded.isDomInteractive(getOrasiDriver());
        } catch (TimeoutException e) {
            // throw new AutomationException("Application did not load within specified time: " + url);
            // do nothing for now?
        }
     ...
     * @return - current OrasiDriver
     */
    private KeebootDriver getOrasiDriver() {
        return this;
    }
