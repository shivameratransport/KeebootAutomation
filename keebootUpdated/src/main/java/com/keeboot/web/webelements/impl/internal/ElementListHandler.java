...
import static com.keeboot.web.webelements.impl.internal.ImplementedByProcessor.getWrapperClass;
...
public class ElementListHandler implements InvocationHandler {
    ...
    public <T> ElementListHandler(Class<T> interfaceType, ElementLocator locator, KeebootDriver driver) {
        this.locator = locator;
        this.driver = driver;
        if (!Element.class.isAssignableFrom(interfaceType)) {
            throw new RuntimeException("interface not assignable to Element.");
    ...
    public Object invoke(Object o, Method method, Object[] objects) throws Throwable {
        ...
        cons = wrappingType.getConstructor(KeebootDriver.class, By.class, WebElement.class);
