...
public class ElementDecorator implements FieldDecorator {
    ...
    public ElementDecorator(CustomElementLocatorFactory factory, KeebootDriver driver) {
        this.factory = factory;
        this.driver = driver;
    }
    ...
    protected <T> T proxyForLocator(ClassLoader loader, Class<T> interfaceType, ElementLocator locator, KeebootDriver driver) {
    ...
    protected <T> List<T> proxyForListLocator(ClassLoader loader, Class<T> interfaceType, ElementLocator locator, KeebootDriver driver) {
