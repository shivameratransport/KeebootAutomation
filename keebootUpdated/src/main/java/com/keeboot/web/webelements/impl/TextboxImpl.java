...
import static com.keeboot.utils.Base64Coder.decodeString;
...
public class TextboxImpl extends ElementImpl implements Textbox {
    ...
    public TextboxImpl(KeebootDriver driver, By by) {
        super(driver, by);
    }

    public TextboxImpl(KeebootDriver driver, By by, WebElement element) {
