...
public class ElementHandler implements InvocationHandler {
     ...
     */
    public <T> ElementHandler(Class<T> interfaceType, ElementLocator locator, KeebootDriver driver) {
    ...
    public Object invoke(Object object, Method method, Object[] objects) throws Throwable {
        ...
        cons = wrappingType.getConstructor(KeebootDriver.class, By.class);
