...
import com.keeboot.utils.JavaUtilities;
import com.keeboot.utils.date.DateTimeConversion;
import com.keeboot.utils.date.SimpleDate;

public class CustomizedEmailableReportSummary implements IReporter {
    ...
    private static final String FINISHED_REPORT_NAME = "automation-email-report-summary";
    private static final String REPORT_TEMPLATE_NAME_PATH = "src/main/resources/html/reportTemplate-emailSummary.html";
    ...
    private void getTestSuiteDetails(List<ISuite> suites) {
        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r : tests.values()) {
                ...
                totalRunTime = (totalRunTime > totalTimeInMS) ? totalRunTime : totalTimeInMS;
