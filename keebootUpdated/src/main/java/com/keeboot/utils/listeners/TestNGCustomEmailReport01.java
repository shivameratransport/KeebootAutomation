...
public class TestNGCustomEmailReport01 implements IReporter {

    private static final Logger L = Logger.getLogger(TestNGCustomEmailReport01.class);
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
         ...
         * }
         */
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, "emailSummary.html"))));
    ...
    protected void endHtml(PrintWriter out) {
        out.println("<h3> This is summary. For details refer attachment. </h3>");
