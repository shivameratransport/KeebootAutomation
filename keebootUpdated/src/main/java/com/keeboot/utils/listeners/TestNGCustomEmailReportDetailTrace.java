...
public class TestNGCustomEmailReportDetailTrace implements IReporter {

    private static final Logger L = Logger.getLogger(TestNGCustomEmailReportDetailTrace.class);
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
         ...
         * }
         */
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, "CustomEmailReportDetailTrace.html"))));
    ...
    protected void generateMethodSummaryReport(List<ISuite> suites) {
        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r2 : r.values()) {
                ...
                // [Govind]: Commented below line as pass test case information is not required
