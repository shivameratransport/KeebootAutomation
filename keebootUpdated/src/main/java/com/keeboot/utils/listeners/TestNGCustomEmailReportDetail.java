...
public class TestNGCustomEmailReportDetail implements IReporter {

    private static final Logger L = Logger.getLogger(TestNGCustomEmailReportDetail.class);
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
         ...
         * }
         */
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, "CustomEmailReportDetail.html"))));
