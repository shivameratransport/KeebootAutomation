...
import com.keeboot.utils.Preamble;
import com.keeboot.utils.TestReporter;
import com.keeboot.utils.mustard.Mustard;
...
public class TestListener extends TestListenerAdapter implements IReporter {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        String destDir = Constants.determineScreenShotPath() + slash + result.getInstanceName().replace(".", slash);
