package com.keeboot.utils.mustard;
...
public class Mustard {
    ...
    @Beta
    public static void postResultsToMustard(KeebootDriver driver, ITestResult result, String runLocation, String base64Screenshot) {
